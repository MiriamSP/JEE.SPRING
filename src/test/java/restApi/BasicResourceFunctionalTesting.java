...
public class BasicResourceFunctionalTesting {
    ...
    private static final String URL_API = "http://localhost:8080/JEE.SpringMSP.0.0.1-SNAPSHOT" + Uris.SERVLET_MAP;
    //http://localhost:8080/JEE.SpringMSP.0.0.1-SNAPSHOT/WEB-INF/classes/restApi/BasicResource.java
